...
/// <summary>
/// Movimento do Personagem 2 (Soldado azul).
/// WASD = andar/correr | Shift = correr | Mouse X = girar o personagem
/// Só funciona quando este personagem está ativo (tecla 2).
/// </summary>
[RequireComponent(typeof(CharacterController))]
public class MovimentoPersonagem2 : MonoBehaviour
{
    public float velocidade = 4.5f;
    public float bonusCorrer = 4f;
    public float gravidade = 9.8f;
    public float rotacaoMouse = 3f;

    CharacterController characterController;
    Animator animator;
    CombatePersonagem2 combate;
    bool ativo;

    public void Configurar(CombatePersonagem2 combatePersonagem)
    {
